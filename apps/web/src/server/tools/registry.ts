...
const TOOL_DEFINITIONS: Record<ToolId, ToolDefinition> = {
  ...
  memory: {
    id: "memory",
    name: "Memory items",
    description: "Manages saved memory artifacts in Quipu's database. Use update/delete only when one target is clear.",
  ...
  tasks: {
    id: "tasks",
    name: "Tasks",
    description: "Manages local tasks in Quipu's database. Treat todos, lists, checklists, and tasks as one task surface.",
